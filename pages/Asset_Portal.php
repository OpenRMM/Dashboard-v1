...
?>
<div class="jumbotron jumbotron-fluid" style="background:#35384e;color:#fff">
...
<?php if($computerID!="0"){ ?>
	<div class="col-md-2 bg-success secbtn" onclick="$('#asset').show();$('#chat').hide();$('#ticket').hide();" style="cursor:pointer;padding:20px;padding-top:20px;padding-bottom:0px;border-radius:5px;height:200px;overflow-x:auto;margin-right:10px">
		<center>
...
<?php } ?>
	<div class="col-md-2 bg-primary secbtn" onclick="$('#chat').show();$('#asset').hide();$('#ticket').hide();loadChat('<?php echo $computerID; ?>');" style="cursor:pointer;padding:20px;padding-top:20px;padding-bottom:0px;border-radius:5px;height:200px;overflow-x:auto;margin-right:10px">
		<center>
			<i style="font-size:50px" class="fas fa-comments"></i><br><br>
			<h5>Start Chat</h5><br>
			<p>Have a quick question? Get help from a support agent.</p>
	</div>
	<div class="col-md-2 bg-warning secbtn" onclick="$('#ticket').show();$('#chat').hide();$('#asset').hide();" style="cursor:pointer;padding:20px;padding-top:20px;padding-bottom:0px;border-radius:5px;height:200px;overflow-x:auto;margin-right:10px">
		<center>
...
<?php } ?>
<div class="row justify-content-md-center" id="ticket" style="display:none;margin-bottom:10px;margin-top:0px;border-radius:3px;overflow:hidden;padding:0px">
	<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6" style="padding-bottom:20px;padding-top:0px;">
