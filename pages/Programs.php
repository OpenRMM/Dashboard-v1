...
<?php 
	...
	$programs = $json['WMI_Product']['Response'];
...
<div class="row" style="background:#fff;padding:15px;box-shadow:rgba(0, 0, 0, 0.13) 0px 0px 11px 0px;border-radius:6px;margin-bottom:20px;">
	...
	<div style="text-align:right;" class="col-md-2">
		<a href="javascript:void(0)" title="Refresh" onclick="loadSection('Programs');" class="btn btn-sm" style="margin:5px;color:#fff;background:<?php echo $siteSettings['theme']['Color 2'];?>;">
